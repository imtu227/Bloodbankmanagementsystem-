		    ...
		    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title text-center" style="padding:5px;font-size:16px;font-weight:bold"> </span> Need Blood To Save Lifes</h3>
                    </div>
					...
					<?php
						if(isset($_POST["submit"]))
						{
								...
								else
								{
								 ...
								 $sql="INSERT INTO request_blood(NAME,GENDER,BLOOD,BUNIT,HOSP,CITY,PIN,RDATE,CNAME,EMAIL,CON1,CON2,REASON,PIC,CADDRESS)
