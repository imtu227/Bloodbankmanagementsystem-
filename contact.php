    ...
    <div class="container" style="margin-top:70px;">
            ...
            <div class="col-md-4">
                ...
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">Phone No.</abbr>: +60169652554 </p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E-Mail</abbr>: <a href="#" >bbms@gmail.com</a>
                </p>
                <p><i class="fa fa-clock-o"></i> 
                    <abbr title="Hours">Hours</abbr>: 24*7</p>
				<p><i class="fa fa-globe"></i> 
                    <abbr title="Website">Website</abbr>: <a href="index.php">www.blood_bank.com</a></p>
